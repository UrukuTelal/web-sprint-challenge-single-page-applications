...
Provides access to the match object, primary use case would be to construct nested paths 

1. How would you explain form validation to someone who has never programmed before?

You information is checked before it is sent.

1. In 1-2 sentences, define end to end testing.

A software testing method that involves testing an application's workflow from beginning to endt
